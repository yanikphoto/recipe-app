                        ...
                        filteredRecipes.length > 0 ? (
                            <ul className="">
                                {filteredRecipes.map(recipe => (
                                    <li key={recipe.id} onClick={() => onSelectRecipe(recipe)} className="flex items-center gap-3 bg-white p-1 rounded-xl cursor-pointer hover:bg-gray-50 transition-colors">
